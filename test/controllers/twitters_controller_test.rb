...
class TwittersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create twitter" do
    assert_difference('Twitter.count') do
      post twitters_url, params: { twitter: { message: @twitter.message, title: @twitter.title } }
    end
  ...
  test "should update twitter" do
    patch twitter_url(@twitter), params: { twitter: { message: @twitter.message, title: @twitter.title } }
